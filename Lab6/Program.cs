/*
Додайте в інтерфейс IDemo властивість Y, яка дозволить звертатися для читання до значення
поля у. Реалізуйте роботу з даною властивістю в класах DemoPoint і DemoShape.
*/
